import { FIVE_K_TO_MILE_OFFSET_SEC, MILE_TO_5K_OFFSET_SEC, TEMPO_OFFSET_SEC_RANGE } from './rules';
...
/**
 * Derives mile pace / 5K pace / tempo pace (all seconds-per-mile) from the
 * most recent time trial, per the clinic's formulas:
...
export function computePaces(trials: TimeTrial[]): Paces | undefined {
  ...
  return { milePace, fiveKPace, tempoPace, per400, sourceTrial: latest };
}
