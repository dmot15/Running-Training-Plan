  ...
  return (
    <div>
      <div className="card">
        <h3>Add a race</h3>
        <p className="muted">
          Adding an <strong>A</strong> race rebuilds the plan from today toward it: base → build → peak, with a taper
          in the final 2 weeks. <strong>B</strong> races just get inserted as that week&apos;s hard day.
        </p>
        <p className="muted">
          Build and peak workouts use the B.A.A. Half Marathon plan style — progression runs, goal-pace tempo
          intervals, race-pace ladders, and periodic &quot;simulation&quot; long runs. Set a goal time below to drive
          your goal pace for those workouts (otherwise it&apos;s predicted from your time trials in Settings).
        </p>
